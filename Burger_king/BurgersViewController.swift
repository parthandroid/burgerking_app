...
class BurgersViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    func setUpData(){
        ...
        let item1 = Item()
        item1.burger_name = "BURGER 1"
        item1.burger_price = "Rs 150"
        
        let item2 = Item()
        item2.burger_name = "BURGER 2"
        item2.burger_price = "Rs 200"
        
        let item3 = Item()
        item3.burger_name = "BURGER 3"
        item3.burger_price = "Rs 159"
        
        let item4 = Item()
        item4.burger_name = "BURGER 4"
        item4.burger_price = "Rs 230"
        
        let item5 = Item()
        item5.burger_name = "BURGER 5"
        item5.burger_price = "Rs 180"
