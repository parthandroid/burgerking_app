...
class SnacksViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    
    
    var items = [Item_snacks]()
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(FeedCell_snacks.self, forCellWithReuseIdentifier: cellId)
    ...
    func setUpData(){
        ...
        let item1 = Item_snacks()
        item1.burger_name = "SNACKS 1"
        item1.burger_price = "Rs 110"
        
        let item2 = Item_snacks()
        item2.burger_name = "SNACKS 2"
        item2.burger_price = "Rs 100"
        
        let item3 = Item_snacks()
        item3.burger_name = "SNACKS 3"
        item3.burger_price = "Rs 109"
        
        let item4 = Item_snacks()
        item4.burger_name = "SNACKS 4"
        item4.burger_price = "Rs 200"
        
        let item5 = Item_snacks()
        item5.burger_name = "SNACKS 5"
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId_snacks, for: indexPath) as! FeedCell_snacks
...
class FeedCell_snacks: UICollectionViewCell {
    
    var obj: SnacksViewController?
    
    var item: Item_snacks? {
    ...
    let image: UIImageView = {
        ...
        let image = UIImageView()
        image.translatesAutoresizingMaskIntoConstraints = false
        image.image = UIImage(named: "snacks")
        image.contentMode = .scaleAspectFit
