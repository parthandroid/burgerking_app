...
class BiryaniViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    
    
    var items = [Item_biryani]()
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(FeedCell_biryani.self, forCellWithReuseIdentifier: cellId)
    ...
    func setUpData(){
        ...
        let item1 = Item_biryani()
        item1.burger_name = "BIRYANI 1"
        item1.burger_price = "Rs 110"
        
        let item2 = Item_biryani()
        item2.burger_name = "BIRYANI 2"
        item2.burger_price = "Rs 100"
        
        let item3 = Item_biryani()
        item3.burger_name = "BIRYANI 3"
        item3.burger_price = "Rs 109"
        
        let item4 = Item_biryani()
        item4.burger_name = "BIRYANI 4"
        item4.burger_price = "Rs 200"
        
        let item5 = Item_biryani()
        item5.burger_name = "BIRYANI 5"
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId_biryani, for: indexPath) as! FeedCell_biryani
...
class FeedCell_biryani: UICollectionViewCell {
    
    var obj: BiryaniViewController?
    
    var item: Item_biryani? {
    ...
    let image: UIImageView = {
        ...
        let image = UIImageView()
        image.translatesAutoresizingMaskIntoConstraints = false
        image.image = UIImage(named: "biryani")
        image.contentMode = .scaleAspectFit
