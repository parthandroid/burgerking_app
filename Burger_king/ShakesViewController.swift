...
class ShakesViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    
    
    var items = [Item_shakes]()
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(FeedCell_shakes.self, forCellWithReuseIdentifier: cellId)
    ...
    func setUpData(){
        ...
        let item1 = Item_shakes()
        item1.burger_name = "SHAKE 1"
        item1.burger_price = "Rs 90"
        
        let item2 = Item_shakes()
        item2.burger_name = "SHAKE 2"
        item2.burger_price = "Rs 95"
        
        let item3 = Item_shakes()
        item3.burger_name = "SHAKE 3"
        item3.burger_price = "Rs 100"
        
        let item4 = Item_shakes()
        item4.burger_name = "SHAKE 4"
        item4.burger_price = "Rs 50"
        
        let item5 = Item_shakes()
        item5.burger_name = "SHAKE 5"
        item5.burger_price = "Rs 70"
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId_shakes, for: indexPath) as! FeedCell_shakes
...
class FeedCell_shakes: UICollectionViewCell {
    
    var obj: ShakesViewController?
    
    var item: Item_shakes? {
